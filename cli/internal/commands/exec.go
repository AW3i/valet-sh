...
func NewExecCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Short:              "Execute a command in the project context",
		Long:               "Executes a command within the valet-sh project environment (correct PHP version, database credentials, etc.).",
